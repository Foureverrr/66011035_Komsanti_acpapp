...
class Customer(Base):
    __tablename__ = 'customer'  # Table name set to lowercase
...
class Vehicle(Base):
    __tablename__ = 'vehicle'  # Table name set to lowercase
    id = Column(Integer, primary_key=True, index=True)
...
class Main(Base):
    __tablename__ = 'main'  # Table name set to lowercase
    id = Column(Integer, primary_key=True, index=True)
...
class Mechanics(Base):
    __tablename__ = 'mechanics'  # Table name set to lowercase
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String(100), nullable=False)
    surname = Column(String(100), nullable=False)
    tel = Column(String(20), nullable=False)
